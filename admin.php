...
<main>
    ...
    <div id="btn-container"><a href="add_admin_student.php"><button>Add New Student</button></a></div>
    <table class="table">
        <thead>
            <tr>
                <th>UserID</th><th>StudentID</th><th>Name</th><th>Phone</th><th>DOB</th><th>Major</th>
                <th>Street</th><th>City</th><th>Country</th><th>Action</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            if ($res->num_rows > 0) {
                ...
                echo "<tr><td colspan='10' style='text-align:center; padding: 30px; color: #7f8c8d;'>🎓 No students registered yet.</td></tr>";
            }
            ?>
        </tbody>
    </table>
    ...
    <div id="btn-container"><a href="add_admin_instructor.php"><button>Add New Instructor</button></a></div>
    <table class="table">
        <thead>
            <tr>
                <th>UserID</th><th>InstructorID</th><th>Name</th><th>Phone</th><th>Dept</th><th>University</th><th>Degree</th><th>Subject</th><th>Action</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            if ($res->num_rows > 0) {
                ...
                echo "<tr><td colspan='9' style='text-align:center; padding: 30px; color: #7f8c8d;'>👨‍🏫 No instructors found.</td></tr>";
            }
            ?>
        </tbody>
    </table>
    ...
    <div id="btn-container"><a href="add_admin_committee.php"><button>Add New Member</button></a></div>
    <table class="table">
        <thead>
            <tr>
                <th>UserID</th><th>CommitteeID</th><th>Name</th><th>Phone</th><th>Specialization</th><th>Action</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            if ($res->num_rows > 0) {
                ...
                echo "<tr><td colspan='6' style='text-align:center; padding: 30px; color: #7f8c8d;'>📋 No committee members found.</td></tr>";
            }
            ?>
        </tbody>
    </table>
