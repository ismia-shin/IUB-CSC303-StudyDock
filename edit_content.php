...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("UPDATE content SET ContentName=?, ContentType=?, AccessLink=?, DateUploaded=? WHERE ContentID=?");
    $stmt->bind_param("ssssi", $name, $type, $link, $dateNow, $id);
    $stmt->execute();
    ...
    <div class="form-container">
        ...
        <form action="edit_content.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="content_name" value="<?= $data['ContentName'] ?>" required>
            </div>
